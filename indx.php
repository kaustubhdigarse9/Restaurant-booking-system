...
<form name="myform" method="POST" onsubmit="return validate()" action="hello.php">
  <div class="container">
...
if($_POST['payment'])
{
  ...
  $query= "INSERT INTO halo100 values('$fname','$adults','$children','$rname','$mobileno','$extra','$time')";
